        ...
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='py-2 text-gray-600'>
                    Будучи выпускником романо-германской филологии и учителем французского языка по образованию, 
                    я никогда бы не подумал что буду делать себе персональный вебсайт для поиска 
                    работы программистом (но жизнь вообще удивительная штука, мне сказали). Мой путь в программировании начался в декабре 2019 года с <a className='border-b border-indigo-500 hover:border-green-500' href="https://www.udemy.com/course/the-complete-web-development-bootcamp/"> курса Анджелы Ю. на юдеми.</a>
